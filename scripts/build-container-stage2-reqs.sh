...
buildah run $cont apt-get -y install --no-install-recommends python-dev-is-python3 python3-dev python-pip-whl make gcc g++ libxml2-dev libxslt1-dev zlib1g-dev patch
